...
public class AuthController {
    ...
    private final String TIME_TO_COOKIE_LIVE;
    private final AuthService authService;
    private final SessionService sessionService;
    private final UserService userService;

    public AuthController(@Value("${session.durationInMin}") String TIME_TO_COOKIE_LIVE, AuthService authService,
    ...
    public String signIn(@Valid @ModelAttribute("signInFormDto") SignInFormDto signInFormDto, BindingResult bindingResult, HttpServletResponse response) {
        ...
        Duration duration = Duration.ofMinutes(Long.parseLong(TIME_TO_COOKIE_LIVE));
    ...
    public String logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        response.setHeader("Set-Cookie", CookieUtil.getEmptyCookie(AUTH_TOKEN_COOKIE_NAME)
                                                   .toString());
        return "redirect:/auth/signin";
    }
}