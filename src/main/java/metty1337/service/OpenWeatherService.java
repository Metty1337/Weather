...
public class OpenWeatherService {
    private static final String URL_FIND_BY_COORDS_REQUEST = "/data/2.5/weather";
    ...
    public OpenWeatherService(RestClient restClient, @Value("${app-dev.api_key}") String apiKey) {
    ...
    public WeatherDto getWeatherByCoords(Location location) {
        ...
        return restClient.get()
                         .uri(uriBuilder -> uriBuilder.path(URL_FIND_BY_COORDS_REQUEST)
